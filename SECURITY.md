...
[security advisory form](https://github.com/Barnett-Studios/cordon/security/advisories/new).
This lets us investigate and ship a fix before the issue is public.

Please include:

- a description of the vulnerability and its impact,
- the `cordon` version and how it was built or installed,
...
`cordon` is a component of the [Barnett Studios agentic-harness
